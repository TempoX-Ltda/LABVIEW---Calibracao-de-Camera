	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Item Name="Type Defs" Type="Folder">
				<Item Name="Config Template Events.ctl" Type="VI" URL="../Support VIs/Type Defs/Config Template Events.ctl"/>
				<Item Name="Image Refs.ctl" Type="VI" URL="../Support VIs/Type Defs/Image Refs.ctl"/>
			</Item>
			<Item Name="Config Template.vi" Type="VI" URL="../Support VIs/Config Template.vi"/>
			<Item Name="Create Image Refs.vi" Type="VI" URL="../Support VIs/Create Image Refs.vi"/>
			...
			<Item Name="ROI Inicial.vi" Type="VI" URL="../Support VIs/ROI Inicial.vi"/>
		</Item>
		<Item Name="Interface.vi" Type="VI" URL="../Support VIs/Interface.vi"/>
		<Item Name="Teste de resolução.vi" Type="VI" URL="../Teste de resolução.vi"/>
		<Item Name="QHM.lvlib" Type="Library" URL="../Support VIs/QHM/QHM.lvlib"/>
		<Item Name="Settings Manager.lvlib" Type="Library" URL="../Support VIs/Configs/Settings Manager.lvlib"/>
