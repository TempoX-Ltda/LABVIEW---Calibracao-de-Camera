...
<Library LVVersion="20008000">
	...
	<Item Name="Type Defs" Type="Folder">
		<Item Name="QMH Cluster.ctl" Type="VI" URL="../../Type Defs/QMH Cluster.ctl"/>
	</Item>
	<Item Name="Create QMH.vi" Type="VI" URL="../Create QMH.vi"/>
	<Item Name="Read Message.vi" Type="VI" URL="../Read Message.vi"/>
	<Item Name="Realease QHM.vi" Type="VI" URL="../Realease QHM.vi"/>
